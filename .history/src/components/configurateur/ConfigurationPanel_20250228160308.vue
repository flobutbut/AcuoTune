...
const FACTEUR_QUALITE_OPTIONS = [
  { value: 0.6, label: 'Son neutre et précis (0.6)' },
  { value: 0.707, label: 'Équilibre standard - Butterworth (0.707)' },
  { value: 0.9, label: 'Plus d\'impact dans les graves (0.9)' }
]
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="mt-1 text-sm text-gray-500">
                Contrôle la résonance et l'amortissement. Une valeur plus élevée donne plus d'impact mais peut créer des résonances.
              </p>
            </div>
          </div>
          <select
          ...
          >
            <option value="0.6">Son neutre et précis (0.6)</option>
            <option value="0.707">Équilibre standard - Butterworth (0.707)</option>
            <option value="0.9">Plus d'impact dans les graves (0.9)</option>
          </select>
        </div>
      </div>
    </div>
